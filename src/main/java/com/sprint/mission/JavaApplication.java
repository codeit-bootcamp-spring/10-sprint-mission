...
public class JavaApplication {
    public static void main(String[] args) {
        ...
        System.out.println(ch.getMembersList());
        ...
        channelService.updateName(ch.getId(), "CodeIt_10");
        ...
        System.out.println(channelService.findMembers(ch.getId()));
