...
//        // 수정
//        try {
//            jcfU1.updateUserName(userId1, "일이삼");
//        } catch (NoSuchElementException e) {
//            System.out.println("수정할 유저가 존재하지 않습니다.");
//        }
//        try {
//            jcfU1.updateUserName(UUID.randomUUID(), "아무거나 유저명");
//        } catch (NoSuchElementException e) {
//            System.out.println("수정할 유저가 존재하지 않습니다.");
//        }
//
...
//        }
        ...
        // read 테스트
        try {
            System.out.println(fUserService.read(fileUId));
        } catch (NoSuchElementException e) {
        ...
        // readAll 테스트
        try {
            System.out.println(fUserService.readAll());
        } catch (Exception e) {
        ...
        // Basic*service 테스트
        // Basic User
        BasicUserService basicJCFUserService = new BasicUserService(new JCFUserRepository());
        BasicUserService basicFileUserService = new BasicUserService(new FileUserRepository());
        ...
        // read
        try {
            System.out.println(basicJCFUserService.read(jcfUserId));
            System.out.println(basicFileUserService.read(fileUserId));
        ...
        try {
            ...
            System.out.println(basicJCFUserService.readAll());
            System.out.println(basicFileUserService.readAll());
            System.out.println();
        ...
        // update
        try {
            basicJCFUserService.updateUserName(jcfUserId, "변경된 황민재JCF");
            System.out.println(basicJCFUserService.read(jcfUserId));
            basicFileUserService.updateUserName(fileUserId, "변경된 황민재File");
            System.out.println(basicFileUserService.read(fileUserId));
