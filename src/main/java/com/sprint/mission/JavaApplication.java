...
public class JavaApplication {
    ...
    static Channel setupChannel(ChannelService channelService) {
        Channel channel = channelService.createChannel("공지 채널");
        return channel;
    }

    static void messageCreateTest(MessageService messageService, Channel channel, User author) {
        Message message = messageService.sendMessage(author.getId(), channel.getId(), "안녕하세요.");
    ...
    public static void main(String[] args) {
        ...
        ChannelService channelService =
                new BasicChannelService(userRepository, channelRepository);

        MessageService messageService =
                new BasicMessageService(userRepository, channelRepository, messageRepository);
