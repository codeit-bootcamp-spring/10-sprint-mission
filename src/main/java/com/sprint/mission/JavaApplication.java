...
import com.sprint.mission.discodeit.service.basic.BasicUserCoordinatorService;
...
public class JavaApplication {
    public static void main(String[] args) {
        ...
        */
        //file서비스
        /*
        FileBasicService<User> userData = new FileBasicService<>("users");
        FileBasicService<Channel> channelData = new FileBasicService<>("channels");
        FileBasicService<Message> messageData = new FileBasicService<>("messages");
        UserService userService = new FileUserService(userData,channelData,messageData);
        ChannelService channelService = new FileChannelService(userService,userData,channelData,messageData);
        UserCoordinatorService userCoordinatorService = new FileUserCoordinatorService(userService, channelService,userData,channelData,messageData);
        MessageService messageService = new FileMessageService(userService,userCoordinatorService,messageData);
        */
        //jcf레포버전
        /*
        ...
        UserCoordinatorService userCoordinatorService = new BasicUserCoordinatorService(userService, channelService,userRepository,channelRepository,messageRepository);
        MessageService messageService = new BasicMessageService(userService,userCoordinatorService,messageRepository);
        */
        //file레포 버전
        ///*
