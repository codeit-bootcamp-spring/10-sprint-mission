...
public class JavaApplication {
    ...
    public static void main(String[] args) {
        ...
        User user1 = userService.create("홍길동", "hong@test.com");
        User user2 = userService.create("김철수", "kim@test.com");
        User user3 = userService.create("박민수", "park@test.com");
        ...
        System.out.println("\n=== 회원 수정 ===");
        userService.update(user2.getId(), "철수킴");
        ...
        Channel channel1 = channelService.create("1번 채널", user1);
        Channel channel2 = channelService.create("2번 채널", user2);
        Channel channel3 = channelService.create("3번 채널", user1);
        ...
        System.out.println("\n=== 채널 수정 ===");
        channelService.update(channel2.getId(), "22222번 채널");
        ...
        for (Channel channel : channelList) {
            ...
            channelService.join(channel.getId(), user1.getId());
            Message message1 = messageService.create(channel.getId(), user1.getId(), "이곳은 " + channel.getName() + " 입니다.");
            Message message2 = messageService.create(channel.getId(), user1.getId(), "안녕하세요");
            Message message3 = messageService.create(channel.getId(), user1.getId(), "저는 홍길동입니다.");

            System.out.println("메시지 생성 완료");

            System.out.println("\n- 메시지 조회");
            messageService.read(channel.getId())
