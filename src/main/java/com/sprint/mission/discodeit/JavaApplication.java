...
//            userService.searchUserAll().forEach(user -> System.out.println(user.getNickname()));
//        } catch (Exception e) {
...
//            System.out.println("전체 조회 테스트");
//            channelService.searchChannelAll().forEach(channel -> System.out.println(channel.getChannelName()));
//        } catch (Exception e) {
//            System.err.println("[전체 조회 실패] " + e.getMessage());
//        }
//
...
//                channelService.searchChannel(channel2.getId()).getMembers()
...
//            System.out.println("전체 조회 테스트");
//            messageService.searchMessageAll().forEach(message -> System.out.println(message.getMessage()));
//        } catch (Exception e) {
//            System.err.println("[전체 조회 실패] " + e.getMessage());
//        }
//
...
//            messageService.searchMessageAll()
