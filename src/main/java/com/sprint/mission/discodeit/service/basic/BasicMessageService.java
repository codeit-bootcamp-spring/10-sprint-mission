...
public class BasicMessageService implements MessageService {
    ...
    List<BinaryContent> attachments = binaryContentCreateRequests.stream()
        .map(attachmentRequest -> {
          ...
          applicationEventPublisher.publishEvent(
              new BinaryContentCreatedEvent(binaryContent.getId(), bytes, binaryContent.getFileName(), binaryContent.getContentType())
          );
  ...
  @Transactional
  @Override
  @PreAuthorize("hasRole('ADMIN') or @basicMessageService.isOwner(#messageId)")
  ...
  public boolean isOwner(UUID messageId) {
