...
public class BasicUserService implements UserService {
  ...
  public UserResponseDTO create(UserCreateRequestDTO req) {
    ...
    if (req.binaryContentDTO() != null) {
      ...
      BinaryContent binaryContent = new BinaryContent(req.binaryContentDTO().contentType(),
          req.binaryContentDTO().file());
...
//        }
    ...
    return userDTOMapper.userToResponse(savedUser,
        userStatusRepository.findByUserId(savedUser.getId()).orElseThrow(
            () -> new NoSuchElementException("해당 UserStatus가 존재하지 않습니다!"))); // Entities -> DTO 후 리
  }
