...
public class BasicChannelService implements ChannelService {
    ...
    public ChannelDto create(PublicChannelCreateRequest request) {
        ...
        eventPublisher.publishEvent(new ChannelCreatedEvent(dto, Set.of()));
    ...
    public ChannelDto create(PrivateChannelCreateRequest request) {
        ...
        eventPublisher.publishEvent(
                new ChannelCreatedEvent(dto, Set.copyOf(request.participantIds()))
        );
        log.info("채널 생성 완료: id={}, name={}", channel.getId(), channel.getName());
        return dto;
    }
    ...
    public ChannelDto update(UUID channelId, PublicChannelUpdateRequest request) {
        ...
        ChannelDto dto = channelMapper.toDto(channel);
        eventPublisher.publishEvent(new ChannelUpdatedEvent(dto, Set.of()));
    ...
    public void delete(UUID channelId) {
        ...
        ChannelDto dto = channelMapper.toDto(channel);
        Set<UUID> receiverIds = channel.getType().equals(ChannelType.PRIVATE)
        ...
        eventPublisher.publishEvent(new ChannelDeletedEvent(dto, receiverIds));
