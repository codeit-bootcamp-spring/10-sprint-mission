...
public class BasicChannelService implements ChannelService {
  ...
  public ChannelDto create(PublicChannelCreateRequest request) {
    ...
    broadcastChannelEvent("channels.created", dto);
    return dto;
  }
  ...
  public ChannelDto update(UUID channelId, PublicChannelUpdateRequest request) {
    ...
    ChannelDto dto = channelMapper.toDto(channel);
    broadcastChannelEvent("channels.updated", dto);
    return dto;
  }
  ...
  public void delete(UUID channelId) {
    ...
    broadcastChannelEvent("channels.deleted", dto);
  }

  private void broadcastChannelEvent(String eventName, ChannelDto dto) {
