...
public enum ErrorCode {
    ...
    MESSAGE_SENDER_MISMATCH("메시지 작성자가 일치하지 않습니다."),

    // BinaryContent 관련 에러 코드
    BINARY_CONTENT_NOT_FOUND("바이너리 컨텐츠를 찾을 수 없습니다."),
    INVALID_CONTENT_TYPE("유효하지 않은 콘텐츠 타입입니다."),
    IMAGE_BINARY_CONVERSION_FAILED("이미지 변환에 실패했습니다."),
    ...
    NOTIFICATION_FORBIDDEN("해당 알림에 접근할 권한이 없습니다."),
