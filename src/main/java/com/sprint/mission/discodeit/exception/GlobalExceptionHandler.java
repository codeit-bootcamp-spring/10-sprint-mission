...
public class GlobalExceptionHandler {
    ...
    private HttpStatus determineHttpStatus(DiscodeitException exception) {
        ...
        return switch (errorCode) {
            ...
            case DUPLICATE_USER, DUPLICATE_READ_STATUS, READ_STATUS_ALREADY_EXISTS ->
                    HttpStatus.CONFLICT;
            case INVALID_USER_CREDENTIALS, INVALID_PASSWORD, INVALID_REFRESH_TOKEN ->
                    HttpStatus.UNAUTHORIZED;
            case MESSAGE_SENDER_MISMATCH, NOTIFICATION_FORBIDDEN -> HttpStatus.FORBIDDEN;
            case PRIVATE_CHANNEL_UPDATE, INVALID_REQUEST, INVALID_CONTENT_TYPE,
                 IMAGE_BINARY_CONVERSION_FAILED -> HttpStatus.BAD_REQUEST;
