...
public class FileUserStatusRepository implements UserStatusRepository {
    ...
    public FileUserStatusRepository() {
        ...
        this.INDEX_FILE = DIRECTORY.resolve("index.ser");
    ...
    private Map<UUID, UUID> loadIndex() {
        ...
        try (
                ObjectInputStream ois =
                        new ObjectInputStream(new FileInputStream(INDEX_FILE.toFile()))
        ) {
            return (Map<UUID, UUID>) ois.readObject();
    ...
    private void saveIndex() {
        try (
                ObjectOutputStream oos =
                        new ObjectOutputStream(new FileOutputStream(INDEX_FILE.toFile()))
        ) {
