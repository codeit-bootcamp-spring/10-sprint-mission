...
class UserControllerTest {
  ...
  void createUser_Success() throws Exception {
    ...
    BinaryContentDto profileDto =
        new BinaryContentDto(UUID.randomUUID(), "profile.jpg", 12L, MediaType.IMAGE_JPEG_VALUE);

    UserDto createdUser = new UserDto(userId, "testuser", "test@example.com", profileDto, false);
  ...
  void findAllUsers_Success() throws Exception {
    ...
    UserDto user1 = new UserDto(userId1, "user1", "user1@example.com", null, true);

    UserDto user2 = new UserDto(userId2, "user2", "user2@example.com", null, false);
  ...
  void updateUser_Success() throws Exception {
    ...
    BinaryContentDto profileDto =
        new BinaryContentDto(
            UUID.randomUUID(), "updated-profile.jpg", 14L, MediaType.IMAGE_JPEG_VALUE);

    UserDto updatedUser =
        new UserDto(userId, "updateduser", "updated@example.com", profileDto, true);
